#===============================================================================
# Implementa nuevas reglas de batalla.
#===============================================================================
class Game_Temp
...
def setBattleRule(*args)
  ...
  raise _INTL("Argumento {1} esperaba una variable después de ella pero no tenía una.", r) if r
end
...
#===============================================================================
# Establece nuevas reglas de batalla durante la preparación de batalla.
#===============================================================================
...
#===============================================================================
# Ediciones para reglas de batalla relacionadas con la captura de Pokémon.
#===============================================================================
...
#===============================================================================
# Utilities para battle_rules["raidStyleCapture"].
#===============================================================================
class Battle::Battler
  def pbRaidStyleCapture(target, chance = nil, fleeMsg = nil, bgm = nil)
    ...
    @battle.pbDisplayPaused(_INTL("¡{1} esta débil! \n¡Tirale una PokeBall ahora!", target.pbThis))
    ...
    when 0
      ...
      if $PokemonStorage.full?
        @battle.pbDisplay(_INTL("¡Pero no queda espacio en la PC!"))
...
#===============================================================================
# Edited para battle_rules["inverseBattle"].
#===============================================================================
module GameData
  class Type
...
class Battle
  ...
  #-----------------------------------------------------------------------------
  # Aliased para battle_rules["noBag"]
  #-----------------------------------------------------------------------------
  alias dx_pbItemMenu pbItemMenu
  def pbItemMenu(idxBattler, firstAction)
    if @noBag
      pbDisplay(_INTL("Los objetos no pueden usarse en esta batalla."))
      return false
    end
  ...
  #-----------------------------------------------------------------------------
  # Aliased para battle_rules["raidStyleCapture"]
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Aliased para battle_rules["battleIntroText"]
  #-----------------------------------------------------------------------------
...
#===============================================================================
# Editado para permitir que el sprite del oponente se deslice en la pantalla de varias maneras.
#===============================================================================
...
#===============================================================================
# Métodos utilizados para establecer atributos salvajes a través de reglas de batalla.
#===============================================================================
class Pokemon
  def moves=(value)
    return if !value
  ...
  #-----------------------------------------------------------------------------
  # Correcciones para clonar objetos de Pokémon.
  #-----------------------------------------------------------------------------
  def set_moves=(value)
    @moves = value
  end
...
#-------------------------------------------------------------------------------
# Used para battle_rules["editWildPokemon"].
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Used para battle_rules["tempPlayer"], ["tempBag"], ["tempParty"] and ["inverseBattle"].
#-------------------------------------------------------------------------------
