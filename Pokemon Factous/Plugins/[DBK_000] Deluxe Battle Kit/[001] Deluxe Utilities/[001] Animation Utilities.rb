...
class Battle::Scene
  #-----------------------------------------------------------------------------
  # Comprueba si existe una animación común.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Reescritura para alternar los datos durante las animaciones de movimiento.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Utilizado para ocultar una sola datos.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Llama a una animación de huir para Pokémon salvaje.
  #-----------------------------------------------------------------------------
  def pbBattlerFlee(battler, msg = nil)
    ...
    if msg.is_a?(String)
      ...
      @battle.pbDisplayPaused(_INTL("¡{1} escapó!", battler.pbThis))
    end
  end
 
  #-----------------------------------------------------------------------------
  # Llama a las animaciones para revertir un luchador de varios estados de batalla.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Llama a la animación para usar un elemento en un luchador.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Utilizado para refrescar toda la escena de batalla con un efecto flash blanco.
  #-----------------------------------------------------------------------------
  def pbFlashRefresh
    pbForceEndSpeech
  ...
  #-----------------------------------------------------------------------------
  # Utilidad para detener el procesamiento de escenas adicionales durante un número determinado de segundos.
  #-----------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Código de animación para animar un luchador que huye.
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Código de animación para revertir a los luchadores de varios estados de batalla.
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Código de animación para animar el uso de un elemento en un luchador.
#-------------------------------------------------------------------------------
...
#===============================================================================
# Llamadas que huyen animación para roaming Pokemon.
#===============================================================================
  ...
  def pbProcessTurn(choice, tryFlee = true)
    ...
    if choice[0] == :Shift
      ...
      if idxOther >= 0
        ...
        case @battle.pbSideSize(@index)
        when 2
          @battle.pbDisplay(_INTL("¡{1} se movió!", pbThis))
        when 3
...
#===============================================================================
#Llamas a la animación que huye para Safari Pokemon.
#===============================================================================
class SafariBattle
  def pbStartBattle
    begin
      ...
      pbDisplayPaused(_INTL("¡{1} salvaje aparecio!", pkmn.name))
      @scene.pbSafariStart
      ...
      loop do
        ...
        when 0
          if pbBoxesFull?
            pbDisplay(_INTL("¡Las cajas están llenas!¡No puedes atrapar más Pokémon!"))
            next
          end
          @ballCount -= 1
          @scene.pbRefresh
        ...
        when 3
          ...
          pbDisplayPaused(_INTL(" ¡{1} huyó del combate!", self.pbPlayer.name))
          @decision = 3
        else
          next
        end
        ...
        if @decision == 0
          if @ballCount <= 0
            ...
            pbDisplay(_INTL(" ¡No quedan más Safari Balls! El safari ha terminado."))
            @decision = 2
            ...
            pbDisplay(_INTL("¡{1} está mirando atentamente!", pkmn.name))
          end
          weather_data = GameData::BattleWeather.try_get(@weather)
          @scene.pbCommonAnimation(weather_data.animation) if weather_data
        end
...
#===============================================================================
#Utilities para animaciones de batalla especiales, como Mega Evolution.
#===============================================================================
class Battle::Scene::Animation
  #-----------------------------------------------------------------------------
  # Utilizado para la compatibilidad de animación con sprites animados de Pokémon.
  #-----------------------------------------------------------------------------  
  ...
  #-----------------------------------------------------------------------------
  # Se usa para oscurecer a todos los sprites en la batalla por las animaciones cinematográficas.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Revierte los cambios realizados por Darkenbattlefield.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece las bases de batalla.Solo establece uno si un entrenador no aparece.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Configura un sprite de entrenador junto con un sprite de elemento para ser "usado".
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece un Pokemon Sprite con un contorno.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Se utiliza específicamente para volver a aplicar patrones de manchas a Spinda Sprites durante las animaciones.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece un sprite con un contorno.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece un sprite para actuar como título.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece un conjunto de cuatro sprites de partículas repitiendo una imagen.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece un conjunto de cuatro sprites de partículas cortados de una sola imagen.
  #-----------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------
  # Establece una superposición de desvanecimiento/desvanecimiento.
  #-----------------------------------------------------------------------------
  def dxSetFade(delay)
...
#-------------------------------------------------------------------------------
# Agrega alias para cambiar los nombres de archivo Pokemon Sprite.Utilizado por ciertas animaciones.
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Obtiene los nombres de archivo para elementos de fondo de batalla.Utilizado por ciertas animaciones.
#-------------------------------------------------------------------------------
class Battle
...
#-------------------------------------------------------------------------------
# Obtiene colores relacionados con cada tipo.Utilizado por ciertas animaciones.
#-------------------------------------------------------------------------------
